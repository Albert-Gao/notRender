declare module 'rebass' {
  ...
  type ProviderClass = React.StatelessComponent<
    ProviderProps
  >;
  ...
  type ButtonClass = React.StatelessComponent<
    ButtonProps
  >;
  ...
  interface NavLinkProps
    extends Color,
      ...
      Space,
      Width {}
  type NavLinkClass = React.StatelessComponent<
    NavLinkProps
  >;
  ...
  type BlockLinkClass = React.StatelessComponent<
    BlockLinkProps
  >;
  ...
  type CapsClass = React.StatelessComponent<
    TextProps & LetterSpacing
  >;
  export const Caps: CapsClass;

  type BlockquoteClass = React.StatelessComponent<
    TextProps
  >;
  ...
  interface DividerProps
    extends Space,
      ...
      BorderColor,
      Color {}
  type DividerClass = React.StatelessComponent<
    DividerProps
  >;
  ...
  type MeasureClass = React.StatelessComponent<
    MeasureProps
  >;
  ...
  interface LabelProps
    extends FontSize,
      ...
      AlignItems,
      Color {}
  type LabelClass = React.StatelessComponent<
    LabelProps
  >;
  ...
  interface InputProps
    extends FontSize,
      ...
      Color,
      BackgroundColor {}
  type InputClass = React.StatelessComponent<
    InputProps
  >;
  ...
  interface SelectProps
    extends Space,
      ...
      Color,
      BackgroundColor {}
  type SelectClass = React.StatelessComponent<
    SelectProps
  >;
  ...
  interface SliderProps
    extends Width,
      ...
      Color,
      BorderRadius {}
  type SliderClass = React.StatelessComponent<
    SliderProps
  >;
  ...
  interface SwitchProps
    extends Color,
      BorderRadius,
      Space {}
  type SwitchClass = React.StatelessComponent<
    SwitchProps
  >;
  ...
  type ImageClass = React.StatelessComponent<
    ImageProps
  >;
  ...
  interface BackgroundImageProps
    extends Width,
      ...
      Color,
      BGImage {}
  type BackgroundImageClass = React.StatelessComponent<
  ...
  interface AvatarProps
    extends Size,
      ...
      Space,
      Color {}
  type AvatarClass = React.StatelessComponent<
    AvatarProps
  >;
  export const Avatar: AvatarClass;

  interface EmbedProps extends Ratio, Space, Color {}
  type EmbedClass = React.StatelessComponent<
    EmbedProps
  >;
  ...
  interface ContainerProps
    extends BoxProps,
      Space,
      MaxWidth {}
  type ContainerClass = React.StatelessComponent<
    ContainerProps
  >;
  export const Container: ContainerClass;

  interface GroupProps extends FlexProps {}
  type GroupClass = React.StatelessComponent<
    GroupProps
  >;
  ...
  type ColumnClass = React.StatelessComponent<
    ColumnProps
  >;
  ...
  interface BorderProps
    extends Border,
      ...
      Width,
      Color {}
  type BorderClass = React.StatelessComponent<
    BorderProps
  >;
  ...
  interface PanelProps
    extends BackgroundColor,
      ...
      BorderColor,
      Space {}
  type PanelClass = React.StatelessComponent<
    PanelProps
  >;
  ...
  interface ProgressProps
    extends Width,
      ...
      Color,
      BorderRadius {}
  type ProgressClass = React.StatelessComponent<
    ProgressProps
  >;
  ...
  interface BannerProps
    extends FlexProps,
      ...
      MinHeight,
      Color {}
  type BannerClass = React.StatelessComponent<
    BannerProps
  >;
  ...
  interface MessageProps
    extends FlexProps,
      ...
      AlignItems,
      MinHeight {}
  type MessageClass = React.StatelessComponent<
    MessageProps
  >;
  ...
  interface ToolbarProps
    extends Space,
      ...
      AlignItems,
      MinHeight {}
  type ToolbarClass = React.StatelessComponent<
    ToolbarProps
  >;
  ...
  interface BadgeProps
    extends FontSize,
      ...
      FontWeight,
      BorderRadius {}
  type BadgeClass = React.StatelessComponent<
    BadgeProps
  >;
  ...
  interface CircleProps
    extends Size,
      ...
      TextAlign,
      Size {}
  type CircleClass = React.StatelessComponent<
    CircleProps
  >;
  ...
  type ArrowClass = React.StatelessComponent<
    ArrowProps
  >;
  ...
  type DonutClass = React.StatelessComponent<
    DonutProps
  >;
  ...
  interface PositionProps
    extends Space,
      ...
      UniversalProps,
      Left {}
  type PositionClass = React.StatelessComponent<
    PositionProps
  >;
  ...
  interface ModalProps
    extends PositionClass,
      ...
      MaxWidth,
      MaxHeight {}
  type ModalClass = React.StatelessComponent<
    ModalProps
  >;
  ...
  type DrawerClass = React.StatelessComponent<
    DrawerProps
  >;
  ...
  type CarouselClass = React.StatelessComponent<
    CarouselProps
  >;
  ...
  type TooltipClass = React.StatelessComponent<
    TooltipProps
  >;
